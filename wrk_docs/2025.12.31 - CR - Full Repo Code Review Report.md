...
6) Legacy Kroki flags remain in regression tooling but are not referenced in the app.
   - Files: tools/regression/runner.py:208, tests/regression/manifest.toml:59
   - Detail: runner sets MDMDVIEW_ENABLE_KROKI and manifest has mermaid_renderer, but no in-app use appears after Kroki removal.
