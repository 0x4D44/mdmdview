...
mod tests {
    ...
    const ALL_EMOJI_CODEPOINTS: [&str; 80] = [
        // Faces (4)
        "\u{1f642}", "\u{1f600}", "\u{1f609}", "\u{1f914}",
        // Status/Indicators (11)
        "\u{2705}", "\u{26a0}", "\u{274c}", "\u{2728}", "\u{1f4af}",
        "\u{23f3}", "\u{1f504}", "\u{2714}", "\u{274e}", "\u{1f6ab}",
        "\u{2611}",
        // Objects/Tools (16)
        "\u{1f4a1}", "\u{1f4dd}", "\u{1f4e6}", "\u{1f527}", "\u{1f517}",
        "\u{1f4cb}", "\u{1f4c1}", "\u{1f4c2}", "\u{1f512}", "\u{1f513}",
        "\u{2699}", "\u{1f50d}", "\u{1f4cc}", "\u{1f528}", "\u{270f}",
        "\u{1f9ea}",
        // Charts (3)
        ...
        // Nature/Symbols (10)
        "\u{2b50}", "\u{1f525}", "\u{2764}", "\u{1f48e}", "\u{1f31f}",
        "\u{1f3af}", "\u{1f3a8}", "\u{1f6e1}", "\u{1f30a}", "\u{26a1}",
        // People/Gestures (7)
        "\u{1f44d}", "\u{1f44e}", "\u{1f440}", "\u{1f44b}", "\u{1f64f}",
        "\u{1f4aa}", "\u{1f9e0}",
        // Dev/Tech (6)
        "\u{1f41b}", "\u{1f6a7}", "\u{1f3d7}", "\u{1f4bb}", "\u{1f5a5}",
        "\u{2328}",
        // Misc (16)
        "\u{1f389}", "\u{1f680}", "\u{2753}", "\u{2757}", "\u{1f3c6}",
        "\u{1f3aa}", "\u{1f4d6}", "\u{1f4da}", "\u{1f514}", "\u{1f515}",
        "\u{1f5c2}", "\u{2139}", "\u{1f534}", "\u{1f7e2}", "\u{1f7e1}",
        "\u{1f535}",
    ];
